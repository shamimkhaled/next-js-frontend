        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Delivering happiness with every meal. Fresh, fast, and delicious food at your doorstep.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link href="/offers" className="hover:text-orange-500 transition-colors">Offers</Link></li>
          ...
          <div>
            ...
            <p className="text-gray-400">
              <strong>Call us:</strong> +1 234 567 8900<br />
